...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.128-kourovka-notebook-problem-21.128-58fc5108-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.128"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.128-kourovka-notebook-problem-21.128-58fc5108-v1",
      "problem_contract_sha256": "ddc98ca9cd036a8fbeb8b3627e256b59ddbce20b2fde6749b40e1902bef7d132",
      "problem_id": "problem:um-kou-21.128-kourovka-notebook-problem-21.128-58fc5108",
      "route_id": "route:um-kou-21.128-kourovka-notebook-problem-21.128-58fc5108-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.128-kourovka-notebook-problem-21.128-58fc5108-source-fidelity-01",
      "graph_id": "graph:um-kou-21.128-kourovka-notebook-problem-21.128-58fc5108-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.128-kourovka-notebook-problem-21.128-58fc5108-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.128-kourovka-notebook-problem-21.128-58fc5108-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Two groups $G_1$ and $G_2$ are said to be commensurable if there exist finite-index subgroups $H_1\\leqslant G_1$ and $H_2\\leqslant G_2$ (not necessarily of the same index) such that $H_1\\cong H_2$. Let $A[F_4]$ and $A[H_4]$ denote the Artin groups of spherical types $F_4$ and $H_4$, respectively. Are these two groups commensurable?"
          },
          "statement_sha256": "475def2656c75980a09641d7c5fe8d0164429f27f3e411c77569736d66384c84"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.128-kourovka-notebook-problem-21.128-58fc5108-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.128-kourovka-notebook-problem-21.128-58fc5108-root",
      "route_id": "route:um-kou-21.128-kourovka-notebook-problem-21.128-58fc5108-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.128-17f691b18d80",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.128"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
